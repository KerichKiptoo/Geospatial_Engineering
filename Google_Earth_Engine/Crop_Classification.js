...
var alos = ee.Image("JAXA/ALOS/AW3D30/V2_2"),
    gcp = ee.FeatureCollection("users/Kerich/Kenya_crops"),
    shapefile = ee.FeatureCollection("users/Kerich/Kenya_shapefile"),
...
//Map.addLayer(classified, {min: 0, max: 3, palette: ['gray', 'brown', 'blue', 'green']}, '2022');
